    ...
    <div className={`${style.FooterWebsite} py-5 `}>
        <div className='container'>
                ...
                <div className="row g-0">
                    ...
                    <div className="col-md-3" data-aos="flip-left" >
                        ...
                        <div className='d-flex align-items-center '>
                            <div>
                                <input type="text" placeholder='Email'  className={`${style.FooterInput} shadow p-3 `} />
                            </div>
            ...
            <div className={`d-flex justify-content-center position-relative   ${style.footerTranslate} `} >
                <img src={image} className='position-absolute d-none d-xl-block'  alt="" data-aos="flip-left" />
            </div>
        </div>
    </div>
  )
