...
export default function NavBar() {
  ...
  return <>
    <nav className={`${Style.navBar} navBar d-flex justify-content-between align-items-center bg-milk`}>
      ...
      <div className="modal-dialog" style={{marginTop:'9rem'}}>
        <div className="modal-content">
          ...
          <div className="modal-footer">
            ...
            <button type="button" className="btn btn-primary" data-bs-dismiss="modal">Logout</button>
          </div>
        </div>
      </div>
    </div>
