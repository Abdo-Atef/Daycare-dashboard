            ...
            <div className='my-5 '>
                <div className="row g-5">
                    ...
                    <div className="col-md-7">
                                <div className={` ${style.EventBgOrange} p-3 rounded-4 d-flex align-items-center`}>
                                ...
                                <div className={` ${style.EventBgGreen} p-3 rounded-4 d-flex align-items-center mt-4`}>
                                ...
                                <div className={` ${style.EventBgNile} p-3 rounded-4 d-flex align-items-center mt-4`}>
                                ...
                                <div className={` ${style.EventBgYellow} p-3 rounded-4 d-flex align-items-center mt-4`}>
